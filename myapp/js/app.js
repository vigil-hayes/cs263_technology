...
(function() {
  ...
  angular.module('MyApp', ['OC']).config([
    '$provide', '$interpolateProvider', function($provide, $interpolateProvider) {
      ...
      Config.routes = {
        saveNameRoute: 'myapp_ajax_setsystemvalue',
        getNameRoute: 'myapp_ajax_getsystemvalue'
      };
...
(function() {
  ...
  angular.module('MyApp').filter('leetIt', function() {
...
(function() {
  ...
  angular.module('MyApp').factory('MyAppRequest', [
    '$http', 'Config', '_MyAppRequest', 'Publisher', function($http, Config, _MyAppRequest, Publisher) {
...
(function() {
  ...
  angular.module('MyApp').factory('_MyAppRequest', [
    '_Request', function(_Request) {
      var MyAppRequest;
      MyAppRequest = (function(_super) {

        __extends(MyAppRequest, _super);

        function MyAppRequest($http, Config, Publisher) {
          MyAppRequest.__super__.constructor.call(this, $http, Config, Publisher);
        }

        MyAppRequest.prototype.saveName = function(route, name) {
          var data;
          data = {
            somesetting: name
          };
        ...
        MyAppRequest.prototype.getName = function(route, scope) {
          var success;
...
(function() {
  ...
  angular.module('MyApp').factory('_ItemModel', function() {
    var ItemModel;
    ItemModel = (function() {
...
(function() {
  ...
  angular.module('MyApp').factory('_ExampleController', function() {
...
(function() {
  ...
  angular.module('MyApp').controller('ExampleController', [
    '$scope', 'Config', 'MyAppRequest', '_ExampleController', 'ItemModel', function($scope, Config, MyAppRequest, _ExampleController, ItemModel) {
