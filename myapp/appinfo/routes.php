...
$this->create('myapp_index_param', '/test/{test}')->action(
	function($params){
		App::main('ItemController', 'index', $params, new DIContainer());
	}
);

$this->create('myapp_index_redirect', '/redirect')->action(
	function($params){
 ...
 * Ajax Routes
 */
$this->create('myapp_ajax_setsystemvalue', '/setsystemvalue')->post()->action(
	function($params){
		App::main('ItemController', 'setSystemValue', $params, new DIContainer());
	}
);

$this->create('myapp_ajax_getsystemvalue', '/getsystemvalue')->post()->action(
	function($params){
